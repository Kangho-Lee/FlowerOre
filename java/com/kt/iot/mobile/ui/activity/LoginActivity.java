...
public class LoginActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button subscribe = (Button) findViewById(R.id.iv_Subscribe_bt);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.iv_Subscribe_bt:
                Intent intent4 = new Intent(Intent.ACTION_VIEW, Uri.parse("http://iotmakers.olleh.com/openp/index.html#/auth/join"));
